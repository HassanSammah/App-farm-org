...
<header>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <img src="/Objects/Images/assets.jpg" class="card-img-top" alt="Farmer Assets">
                    <div class="card-body">
                        <h5 class="card-title">Farmer Assets</h5>
                        <p class="card-text">View the list of assets you own.</p>
                        <a href="/path/to/farmer-assets.php" class="btn btn-primary">View Assets</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <img src="/Objects/Images/storage.jpg" class="card-img-top" alt="Storage">
                    <div class="card-body">
                        <h5 class="card-title">Storage</h5>
                        <p class="card-text">Manage your stored products.</p>
                        <a href="/path/to/storage.php" class="btn btn-primary">Manage Storage</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <img src="/Objects/Images/livestock.jpg" class="card-img-top" alt="Livestock">
                    <div class="card-body">
                        <h5 class="card-title">Livestock</h5>
                        <p class="card-text">Track and monitor your livestock.</p>
                        <a href="/path/to/livestock.php" class="btn btn-primary">Manage Livestock</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <img src="/Objects/Images/products-for.jpg" class="card-img-top" alt="Products">
                    <div class="card-body">
                        <h5 class="card-title">Products</h5>
                        <p class="card-text">Browse and order farm products.</p>
                        <a href="/path/to/products.php" class="btn btn-primary">Browse Products</a>
                    </div>
                </div>
            </div>
        </div>
...
<footer class="footer mt-auto py-3">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h5>Feedback</h5>
          <form action="my-stock.php" method="POST">
            <div class="mb-3">
