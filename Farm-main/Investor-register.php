        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="contact-container">
                    <h2>To Register as Investor - Contact Us</h2>
                    <form class="contact-form" action="Investor-register.php" method="post">
                        <div class="mb-3">
                        ...
                        <h2>We offer you an Account after ID validation</h2>
                    </form>
                </div>
            </div>
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO contactlist (name, email, message) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sss", $name, $email, $message);
    
    if ($stmt->execute()) {
        // Data inserted successfully
        echo '<div class="alert alert-success" role="alert" align="center" >Thank you for contacting us!</div>';
    } else {
        // Error occurred while inserting data
        echo '<div class="alert alert-warning" role="alert">Error !</div>' . $sql . "<br>" . $conn->error;
    }
